...
public class CreateDestinationConfirmAction extends ActionSupport implements SessionAware {
	...
	//	フォームの入力内容をinputCheckerを使用してチェックします。
	//	入力に不備があった場合、sessionにエラーメッセージをのせます(createDestination.jspに表示)。
		...
		userAddressErrorMessageList = inputChecker.doCheck("住所", userAddress, 15, 50, true, true, true, true, true, true, false, true);
